...
// Tracer bullet: Placeholder for transformation rules
  ...
  <Paper sx={{ p: 2, mb: 2, bgcolor: 'grey.50' }}>
    ...
    <List dense>
      <ListItem>
        ...
        <ListItemText 
          primary="Required Field Validation"
          secondary="Asset Tag, Name must be present"
        />
      </ListItem>
      <ListItem>
        ...
        <ListItemText 
          ...
          secondary="Asset ID → assetTag, Building → buildingName"
        />
      </ListItem>
      <ListItem>
        <ListItemIcon><Check fontSize="small" /></ListItemIcon>
        <ListItemText 
          ...
          secondary="Status: ACTIVE, Condition: GOOD"
        />
      </ListItem>
    </List>
